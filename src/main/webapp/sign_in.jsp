                ...
                <div class="index-main_box">
                    <div class="index-box-label">
                        <h2 class="index_label">
                            <fmt:message key="local.sign_in.label"/>
                        </h2>
                    </div>
                    <div class="index-box-login">
                        <form action="${pageContext.request.contextPath}/controller" method="post" class="index_form">
                            <input type="hidden" name="command" value="create_user"/>
                            <input class="index_input" placeholder="<fmt:message key="local.username"/>" type="text"
                                   name="userName"/><br/>
                            <input class="index_input" placeholder="<fmt:message key="local.password"/>" type="password"
                                   name="password"/><br/>
                            <input class="index_input" placeholder="<fmt:message key="local.repeat_password"/>"
                                   type="password" name="repeatPassword"/><br/>
                            <input class="index_input_sub" type="submit"
                                   value="<fmt:message key="local.sign_in.button"/>"/><br/>
                        </form>
                        <div class="index_content_links">
                            ...
                            <div class="index_links">
                                <div class="index_link_cont">
                                    <a href="./index.jsp" class="index_link"><fmt:message key="local.login"/></a>
                                </div>
                            </div>
                        </div>
                    </div>
